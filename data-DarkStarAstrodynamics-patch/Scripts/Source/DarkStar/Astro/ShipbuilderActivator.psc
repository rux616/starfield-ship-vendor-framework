Scriptname DarkStar:Astro:ShipbuilderActivator Extends OutpostEventHandlerParent
...
ActorValue Property DSA_DarkStarDetected Auto Const mandatory
...
Function ApplyDarkStarKeywords()
    string fnName = "ApplyDarkStarKeywords"
    _Log(fnName, "begin", LL_DEBUG)

    If (Game.GetPlayer().GetValue(DSA_DarkStarDetected) as int) == 1
        _Log(fnName, "DarkStar detected, applying keywords", LL_INFO)

        ; vfilter_DarkStarAstrodynamics_Mortal
        Form darkStarKeyword1 = Game.GetFormFromFile(0x00037D, "DarkStar.esm")
        ; vfilter_DarkStarAstrodynamics_Starborn
        Form darkStarKeyword2 = Game.GetFormFromFile(0x003915, "DarkStar.esm")

        If darkStarKeyword1 && darkStarKeyword1 != None && darkStarKeyword1 is Keyword
            MyVendor.AddKeyword(darkStarKeyword1 as Keyword)
        EndIf
        If darkStarKeyword2 && darkStarKeyword2 != None && darkStarKeyword2 is Keyword
            MyVendor.AddKeyword(darkStarKeyword2 as Keyword)
        EndIf
    EndIf
