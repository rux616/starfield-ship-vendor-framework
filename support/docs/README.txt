...
License
=======
- All code created for this mod is copyright Dan Cassidy (see individual files for exact years), and is licensed under the GPL v3.0 or later (https://www.gnu.org/licenses/gpl-3.0.en.html).
